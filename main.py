...
try:
    ...
    4. **Форматирование** — редко используй символы для форматирования в формате HTML, вроде <b>жирного<b>, <span class="tg-spoiler">Спойлеров</span>, <code>моно<code>, <i>курсив<i> и прочих шрифтов. Чаще отвечай обычным текстом. Но если очень хочется выделить слово — пиши его КАПСОМ или очень-очень редко используй эмодзи.
