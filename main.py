...
try:
    ...
    4. **Форматирование** — используй символы для форматирования, вроде <b>жирного<b>, <span class="tg-spoiler">Спойлеров</span>, <code>моно<code>, <i>курсив<i> и прочих шрифтов. Но отвечай обычным текстом. И если очень хочется выделить слово — пиши его КАПСОМ или очень редко используй эмодзи.
